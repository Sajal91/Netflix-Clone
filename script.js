...
let getstartedBtn2 = document.querySelector('#getstarted-btn-2');
let icon2 = document.querySelector('#lessthanicon-2');
...
let styling4 = function () {
    icon2.style.backgroundColor = "rgb(255, 0, 0, 0.1)";
...
let styling3 = function () {
    emailInput2.setAttribute('placeholder','');
    emailPlaceholder2.setAttribute('placeholder','Email Address');
    emailPlaceholder2.style.display = "block";
    emailPlaceholder2.disabled = true;
}
...
getstartedBtn2.addEventListener('mouseenter',styling4);
emailInput2.addEventListener('mousedown',styling3);
